...
window.GPEN_I18N = {
  ...
  strings: {
    ...
    "This erases {name}'s training on this device.": "Esto borra la formación de {name} en este dispositivo.",
    "This erases all training on this device.": "Esto borra toda la formación en este dispositivo.",
    "That includes {lost}.": "Eso incluye {lost}.",
    "This cannot be undone. Continue?": "Esta acción no se puede deshacer. ¿Continuar?",
    "Switch to a different person": "Cambiar a otra persona",
    "Not you?": "¿No es usted?",
    ...
    "Learn each product, pass the quiz, get certified — then earn a code for up to <b>{pct}% off</b> at gpen.com": "Apréndase cada producto, apruebe el examen y obtenga la certificación: así gana un código de hasta un <b>{pct}% de descuento</b> en gpen.com",
    "{total} products · about {min} minutes each": "{total} productos · unos {min} minutos cada uno",
    "Start training": "Empezar la formación",
    ...
    "Say this": "Diga esto",
    "Never": "Nunca",
    "Never make a health claim.": "Nunca haga una afirmación de salud.",
    "You can't say it's safer, healthier, or easier on anyone's lungs.": "No puede decir que sea más seguro, más saludable ni más suave para los pulmones de nadie.",
    "You can say": "Puede decir",
    "it heats instead of burns, and tastes better.": "que calienta en lugar de quemar y sabe mejor.",
  ...
  courses: {
    "dash-ii": {
      ...
      howToSell: {
        ...
        keyFacts: [
          ...
          "$49.95 precio de nivel de entrada",
        ],
      },
    },
    "dash-plus": {
    ...
    "grinder": {
      ...
      tagline: "Dientes microrredondeados que separan la flor en lugar de desgarrarla. Sin filtro, 64 mm (2,5\").",
      differentiator: "Dientes microrredondeados: la mayor retención de THC en pruebas de terceros.",
      description: [
