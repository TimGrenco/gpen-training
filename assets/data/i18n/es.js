...
window.GPEN_I18N = {
  ...
  strings: {
    ...
    "Check your connection and reload. Your progress and certificates are safe.": "Comprueba tu conexión y vuelve a cargar. Tu progreso y tus certificados están a salvo.",
    ...
    "Say this": "Diga esto",
    "Never a health claim.": "Nunca hagas afirmaciones de salud.",
    "If a customer raises coughing, harshness, lungs, or any other health topic, do not diagnose it and do not say the product fixes it. Redirect to flavor and experience, or refer them to their doctor.": "Si un cliente menciona tos, aspereza, pulmones o cualquier otro tema de salud, no lo diagnostiques ni digas que el producto lo soluciona. Redirige al sabor y la experiencia, o remítelo a su médico.",
    ...
    "Issuing your code…": "Emitiendo tu código…",
    "Your code didn't come through": "Tu código no llegó",
    "Your certificate is saved. Reload this page to try again — nothing is lost.": "Tu certificado está guardado. Vuelve a cargar esta página para intentarlo de nuevo: no se pierde nada.",
  ...
  courses: {
    "dash-ii": {
      ...
      howToSell: {
        ...
        trap: "Nunca lo describa como algo parecido a fumar. Diga que calienta la flor y no la quema. Si un cliente menciona tos, irritación, pulmones o cualquier otro tema de salud, NO haga un diagnóstico y NO diga que el producto lo soluciona. Es una afirmación que la marca no puede hacer. Redirija la conversación al sabor y a la experiencia, o remítalo a su médico.",
        keyFacts: [
          "Vaporizador de hierba seca de bolsillo",
    ...
    "grinder": {
      ...
      description: [
        "El G&nbsp;Pen Grinder es un grinder de <strong>3 piezas y 64 mm</strong> mecanizado con precisión en resistente <strong>aluminio anodizado 6063</strong>, la misma familia de materiales de calidad aeronáutica que los dispositivos a los que alimenta.",
