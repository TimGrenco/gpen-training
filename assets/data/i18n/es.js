...
window.GPEN_I18N = {
  ...
  strings: {
    ...
    "Continue your product training.": "Continúe su formación de producto.",
    "Product training for retail staff.": "Formación de producto para personal de tienda.",
    ...
    "Not yet certified": "Aún sin certificar",
    "Review": "Repasar",
    "Open": "Abrir",
    ...
    "Pass one course to unlock your first code": "Apruebe un curso para desbloquear su primer código",
    "{pct}% off unlocked": "{pct}% de descuento desbloqueado",
    "one more course for the top discount": "un curso más para el descuento máximo",
    "keep certifying": "siga certificándose",
    "Full lineup certified. The top discount is unlocked.": "Gama completa certificada. El descuento máximo está desbloqueado.",
    ...
    "Three key points": "Tres puntos clave",
    ...
    "your answer, incorrect": "su respuesta, incorrecta",
    "Correct.": "Correcto.",
    ...
    "Save story image": "Guardar imagen para stories",
