...
window.GPEN_I18N = {
  ...
  strings: {
    ...
    "Learn each product, pass the quiz, get certified — then earn a code for up to <b>{pct}% off</b> at gpen.com": "Impara ogni prodotto, supera il quiz e ottieni la certificazione: guadagni un codice fino al <b>{pct}% di sconto</b> su gpen.com",
    "{total} products · about {min} minutes each": "{total} prodotti · circa {min} minuti ciascuno",
    ...
    "A G Pen retail shelf: the countertop POP displays grouped into dry herb, concentrates and 510 batteries, each with its price flag.": "Uno scaffale di negozio G Pen: gli espositori POP da banco raggruppati in erba secca, concentrati e batterie 510, ognuno con la sua etichetta di prezzo.",
    ...
    "Say this": "Dica così",
    "Never": "Mai",
    "Never make a health claim.": "Non fare mai un’affermazione sulla salute.",
    "You can't say it's safer, healthier, or easier on anyone's lungs.": "Non puoi dire che sia più sicuro, più sano o più delicato sui polmoni.",
    "You can say": "Puoi dire",
    "it heats instead of burns, and tastes better.": "che riscalda invece di bruciare e ha un sapore migliore.",
  ...
  courses: {
    ...
    "grinder": {
      ...
      tagline: "Denti micro-arrotondati che separano il fiore invece di lacerarlo. Senza filtro, 64 mm (2,5\").",
      differentiator: "Denti micro-arrotondati: la più alta ritenzione di THC in test di terze parti.",
      description: [
        "Ogni buona sessione parte da una macinatura migliore. Il G&nbsp;Pen Slim 3-Piece Grinder è progettato con <strong>denti micro-arrotondati</strong> che separano delicatamente il fiore in una macinatura uniforme, aiutando a preservare i cannabinoidi e i terpeni che rendono unica ogni varietà.",
        "A differenza dei grinder con denti affilati, la geometria arrotondata e l’interno liscio <strong>riducono attrito e accumuli</strong>, così resta più fiore dove deve stare. La struttura a 3 pezzi <strong>senza filtro</strong> mantiene i tricomi mescolati al macinato invece di separarli, e il profilo sottile entra in tasca o in borsa.",
        "Realizzato in <strong>alluminio anodizzato 6063 di grado aeronautico</strong>, offre rotazione fluida, durata e precisione. In test indipendenti di <strong>Orange Photonics</strong>, il design a denti micro-arrotondati ha mostrato la più alta ritenzione di THC dopo la macinatura tra i tipi di grinder testati.",
        "La macinatura uniforme che produce è ideale per la vaporizzazione, quindi si abbina naturalmente a <strong>G&nbsp;Pen Dash II</strong> e <strong>G&nbsp;Pen Dash+</strong>: carica uniforme e più sapore a ogni sessione.",
      ],
      highlights: [
        "3 pezzi, 64 mm (2,5\")",
