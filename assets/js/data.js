...
window.GPEN_COURSES = [
  ...
  /* ------------------------------------------------------------------- DASH+ */
  {
    ...
    minutes: 7, passPct: 80, msrp: "$99.95", accent: "#D75D43",
    ...
    quiz: [
      { q: "A customer is buying top-shelf flower. What is the strongest way to open?", choices: ["“Do you want to see our most popular vaporizer?”", "“How much do you care about how it tastes?”", "“Have you got a budget in mind for today?”", "“Do you want the one with the color screen?”"], answer: 1, why: "Ask about the thing this product is for. Flavor is the reason the Dash+ costs double, so a customer who says it matters has told you which pitch to use." },
      ...
      { q: "A customer asks how the Dash+ actually heats the flower.", choices: ["Conduction only, straight off the chamber wall", "Convection only, hot air passing through it", "Convection and conduction together, in titanium", "Induction, which is why it heats in 20 seconds"], answer: 2, why: "Hybrid heating is the product. Hot air moves through the load while the titanium chamber heats it from the wall, and that combination is what the extra money buys." },
      { q: "A rep tells a Dash II owner to trade up because “the Dash+ oven is bigger.” What is wrong with that pitch?", choices: ["Both hold 0.4g — the upgrade is heat, not size", "Nothing is wrong, the Dash+ does hold more herb", "The Dash+ chamber is smaller, so sell the display", "The claim is fine, the real upgrade is the battery"], answer: 0, why: "Both chambers hold 0.4g, so a bigger-oven promise is untrue and gets found out the first time they pack it. The Dash+ earns its price on how it heats, not on how much it holds." },
      ...
      { q: "“This looks complicated,” a customer says, turning it over.", choices: ["It is simpler than it looks once you read the manual", "Three buttons — load it, double-click, then draw", "The three-button layout takes a session to learn", "You will pick up the temperature settings quickly"], answer: 1, why: "Answer the fear by shrinking the process rather than explaining it. Three actions, and it buzzes when it is ready. A manual or a learning curve confirms the worry instead of removing it." }
    ],
  },
