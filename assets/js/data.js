...
window.GPEN_COURSES = [
  /* ------------------------------------------------------------------ DASH II */
  {
    ...
    quiz: [
      ...
      { q: "A customer puts a half-ounce of flower on the counter and nothing else. Which two things attach to that sale?", choices: ["A Hydout at $24.95 and a 510 Original at $12.95", "A 3-Piece Grinder at $19.95 and a Dash II at $49.95", "A Melt Hot Knife at $24.95 and a Hydout at $24.95", "A second half-ounce and a 3-Piece Grinder at $19.95"], answer: 1, why: "Attach to what is actually in the basket. Flower has to be broken up and then heated, so the grinder and the Dash II are the two pieces that belong to this sale. A 510 battery attaches to a cartridge and a hot knife to concentrate — offering either here is guessing at a purchase they have not made, and it reads that way across the counter." },
      { q: "A flower customer picks up the Dash II and asks, \"so is this basically like smoking it?\"", choices: ["Pretty much the same, but it is smoother on your throat", "It is the healthier way to do it, most people switch for that", "It heats the flower instead of burning it, so you taste the strain", "Yes, it is the same thing, just electric instead of a lighter"], answer: 2, why: "Heating rather than burning is the whole product in one sentence, and it is a fact you can state. The two answers reaching for throat comfort or health are claims the brand cannot make and you must not make at the counter. And calling it the same as smoking throws away the only reason to buy it." }
    ],
  },
  ...
  /* ------------------------------------------------------------------- DASH+ */
  {
    ...
    quiz: [
      ...
      { q: "A regular who buys top-shelf flower every week already owns a grinder. What do you put in front of them?", choices: ["The Dash+ at $99.95, the model that does that flower justice", "The Dash II at $49.95, because the cheaper one closes faster", "The Melt Hot Knife at $24.95, the next step up in the range", "The Dash+ at $99.95 and a spare grinder to keep at work"], answer: 0, why: "Match the device to what they already spend on flower. Buying top-shelf every week tells you they care about taste, which is exactly the Dash+ argument. Defaulting to the cheaper model on that customer leaves the better fit unmentioned, and the Melt is a concentrate tool — a different category, not a step up from a dry herb vaporizer." },
      { q: "A customer turns the Dash+ over and says, \"this looks complicated.\" What answers that best?", choices: ["It is simpler than it looks once you have read the manual", "The three-button layout takes a session or two to learn", "Three buttons: load, double-click, draw. It buzzes when ready", "You will get the hang of the temperature settings soon enough, most do"], answer: 2, why: "Answer the fear, not the feature list. What worries them is not knowing when to inhale, and the device solves precisely that — it shows the temperature and buzzes when it reaches it. Compressing the whole operation to three steps is what makes it sound simple; sending them to a manual confirms the fear instead." }
    ],
  },
