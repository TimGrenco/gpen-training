...
window.GPEN_COURSES = [
  ...
  /* ------------------------------------------------------- 3-PIECE GRINDER */
  {
    ...
    quiz: [
      ...
      { q: "A customer turns it over and asks where the kief goes.", choices: ["It stays in your grind, because there is no screen", "The bottom chamber collects it once the screen fills", "It sits under the teeth and you tap it out later", "A screen is included in the box if they want one"], answer: 0, why: "Screenless is a feature rather than an omission: the trichomes stay mixed into the ground flower and go in the bowl with it. Say it forwards — a customer expecting a fourth chamber brings the grinder back." },
