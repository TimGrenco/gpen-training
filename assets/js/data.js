...
window.GPEN_COURSES = [
  ...
  /* ------------------------------------------------------- 3-PIECE GRINDER */
  {
    ...
    quiz: [
      { q: "A customer picks up the 3-Piece Grinder, turns it over and asks whether it has a kief screen. What do you tell them?", choices: ["Yes, there is a fine screen under the catch cup", "There is no kief screen — everything stays together on purpose", "Kief collects under the teeth and you scrape it out", "You have to buy the four-piece for that"], answer: 1, why: "This is the single most common question on a 3-piece and the fastest route to a return if you fudge it. There is no kief screen at all, which the one-sheet frames as the feature: flower, trichomes and kief stay together instead of separating into a chamber people forget." },
  ...
  /* ------------------------------------------------------------- 510 ORIGINAL */
  {
    ...
    howToSell: {
      ...
      objections: [
        { says: "I have an old battery at home.", say: "If it still works, good. This one is $12.95 and is built for the thread on the cartridge you just bought.", why: "Concede, then reframe on fit and price. The earlier draft claimed an unmatched battery runs a cart too hot — an unproven safety claim, and the Hydout course explicitly forbids inventing one to win." },
