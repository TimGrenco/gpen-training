...
window.GPEN_COURSES = [
  ...
  /* ------------------------------------------------------- 3-PIECE GRINDER */
  {
    ...
    quiz: [
      ...
      { q: "A customer says the grinder they already have was free. What is the material difference?", choices: ["Theirs is aluminum too, just a thinner grade of it", "Theirs has a steel grinding ring instead of teeth", "Theirs is plastic, so it sheds plastic into the flower", "Theirs is anodized, so the coating wears off sooner"], answer: 2, why: "Free grinders are almost always plastic, and plastic shaves off into whatever you grind. This one is machined aluminum, so nothing sheds into the flower — a difference a customer can feel by picking both up." },
