...
window.GPEN_COURSES = [
  ...
  /* ------------------------------------------------------- 3-PIECE GRINDER */
  {
    ...
    description: [
      ...
      "Crafted from <strong>6063 aircraft-grade anodized aluminum</strong>, it delivers smooth rotation, lasting durability and precision performance. In independent testing by <strong>Independent Testing Labs</strong>, the micro-rounded tooth design showed the highest post-grind THC retention among the grinder styles tested.",
    ...
    quiz: [
      { q: "A customer asks what the micro-rounded teeth actually do.", choices: ["They sift the kief down into the bottom chamber", "They separate the flower instead of shredding it", "They grind noticeably faster than sharp teeth do", "They stop the lid sticking when the chamber is full"], answer: 1, why: "Rounded rather than sharpened is the whole design: the teeth part the flower instead of tearing it." },
      { q: "A customer is skeptical: “Does the tooth shape really change anything?”", choices: ["It is a design choice, mostly about how it feels to turn", "It doubles what you get out of the same amount of flower", "It produces a finer grind than any sharp-tooth grinder", "It is proven to retain more of your THC and terpenes"], answer: 3, why: "This is the one claim with testing behind it — Independent Testing Labs compared grinder styles and this design retained the most after grinding. Say it plainly, and do not stretch it into a yield promise or a claim about fineness, because neither of those was tested." },
      { q: "A customer says the grinder they already have was free. What is the material difference?", choices: ["Free grinders are usually aluminum as well, just a thinner grade of it", "Free grinders use a steel grinding ring in place of proper teeth", "Free grinders are most likely plastic, so they shed plastic into the flower", "Free grinders are anodized, so the coating wears off much sooner"], answer: 2, why: "Free grinders are almost always plastic, and plastic shaves off into whatever you grind. This one is machined aluminum, so nothing sheds into the flower — a difference a customer can feel by picking both up." },
      { q: "A customer turns it over and asks where the kief goes.", choices: ["It stays in your grind, because there is no screen", "The bottom chamber collects it once the screen fills", "It sits under the teeth and you tap it out later", "A screen is included in the box if they want one"], answer: 0, why: "Screenless is a feature rather than an omission: the trichomes stay mixed into the ground flower and go in the bowl with it." },
