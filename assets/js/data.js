...
window.GPEN_COURSES = [
  /* ------------------------------------------------------------------ DASH II */
  {
    ...
    howToSell: {
      ...
      vital: "Flower only does its job heated clean — burning it torches the terpenes they paid for. The Dash II is how a flower customer actually tastes the strain.",
