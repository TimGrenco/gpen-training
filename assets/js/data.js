...
window.GPEN_COURSES = [
  /* ------------------------------------------------------------------ DASH II */
  {
    ...
    quiz: [
      { q: "A customer puts a half-ounce of flower on the counter. What is the strongest way to open?", choices: ["“Do you need a grinder to go with that?”", "“Have you tried a dry herb vaporizer?”", "“Can I show you what is on sale today?”", "“Are you a smoker, or more of an edibles person?”"], answer: 1, why: "Open with a question they can answer, about the thing they are already buying. It tells you which conversation you are in before you spend your one good sentence. Leading with a product or a discount asks them to decide before they know why." },
      ...
      { q: "“Is $49.95 worth it?” What is the strongest answer?", choices: ["“It is on sale this week, so it works out cheaper”", "“It has the features of a $100 device for half that”", "“You will make the money back within a month or two”", "“It is the cheapest one we carry, so there is no risk”"], answer: 1, why: "Say what the money buys: temperature control, a ceramic chamber and a built-in tool are $100 features at $50. Discounting into the objection teaches them to wait for a sale, and a payback promise is not yours to make." },
      { q: "You have held the price and they are buying. What has to happen before they leave?", choices: ["Attach a USB-C cable, because it is not in the box", "Register the device so the warranty runs longer", "Show them the tools they will need to clean it", "Set the temperature they ought to start out on"], answer: 0, why: "The box has no charging cable, so the sale is not finished until you close that gap — a customer who gets home and cannot charge it comes back annoyed. Registration and cleaning both matter later; neither stops them using it tonight." },
